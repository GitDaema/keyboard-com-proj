...
# 역할별 팔레트(가시성 최적화)
# 1비트 모드(온/오프) — ARG는 1비트, OFF는 블랙로 통일하여 번짐 최소화
IR_ONOFF = {
    # OP/DST의 1비트 팔레트는 현재 사용하지 않지만 기본값 제공
    "OP":  ((200, 200, 200), (0, 0, 0)),   # placeholder
    "DST": ((200, 200, 200), (0, 0, 0)),   # placeholder
    # ARG/IMM: 고가시성 앰버 톤, OFF는 완전 블랙
    "ARG": ((255, 170, 0), (0, 0, 0)),
}
